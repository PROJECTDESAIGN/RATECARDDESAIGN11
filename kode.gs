...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan Oranye Cerah (#E65100) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #E65100}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#E65100;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#E65100;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#E65100;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone oranye soft (#FFF8F0) */
    '.info-box{background:#FFF8F0;border:1px solid #FFE0B2;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Oranye Cerah (#E65100) */
    '.paket-box{background:#E65100;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    ...
    /* Box transfer disesuaikan ke nuansa soft amber (#FFF3E0) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#FFF3E0;border:1px solid #FFCC80;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#BF360C;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #FFE0B2;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
